...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $em)
    {
        ...
        $job_sensio_labs->setDescription('You\'ve already developed websites with symfony...');
        $job_sensio_labs->setHowToApply('Send resume to fabien.potencier [at] sensio.com');
