...
class JobAdminController extends Controller
{
    ...
    /**
     * Gets activated before the confirmation to ensure there is
     * something to confirm.
     * The selection of the jobs is handled by the cleanup method, so
     * we'll always return true here.
     */
    ...
    /**
     * Run the JobRepository::cleanup() method
     */
